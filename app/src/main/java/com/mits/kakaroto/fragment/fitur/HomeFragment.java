...
public class HomeFragment extends Fragment {
    ...
    private void initView() {
        ...
        list.add(new Movie("Max Steel", "Action", "2016", "UK", "1:32:40",
                R.drawable.action_max_steel));
        list.add(new Movie("Code Of Honor", "Action", "2016", "USA", "1:46:07",
                R.drawable.action_code_of_honor));

        list.add(new Movie("Kuroko No Basuke", "Anime", "2016", "Japan", "1:56:51",
                R.drawable.anime_kuroko_no_basuke));
        list.add(new Movie("Dragon Ball", "Anime", "2015", "Japan", "1:33:57",
                R.drawable.anime_dragon_ball_resurrection_f));
        list.add(new Movie("Saint Seiya", "Anime", "2014", "Japan", "1:43:27",
                R.drawable.anime_saint_seiya));
        ...
        list.add(new Movie("At Cafe 6", "Comedy", "2016", "Taiwan", "1:43:20",
                R.drawable.comedy_at_cafe_6));
